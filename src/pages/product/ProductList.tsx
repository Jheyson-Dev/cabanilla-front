...
export const ProductList = () => {
  ...
  // ESTADO PARA EL DIALOG DE KARDEX
  const [isDialogKardexOpen, setIsDialogKardexOpen] = useState(false);
      ...
      {/* <div className="flex justify-between items-center p-4 rounded-lg border">
        <div className="space-x-2">
          <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent>
              <DialogHeader>
                <DialogTitle>Create Kardex</DialogTitle>
                <DialogDescription>
        ...
        <div className="space-x-2 flex gap-2">
          <Dialog
            open={isDialogKardexOpen}
            onOpenChange={setIsDialogKardexOpen}
          >
            <DialogTrigger>
              <Button
                variant="default"
              ...
              >
                <CircleArrowDataTransferHorizontalIcon size={20} />
                Kardex
              </Button>
            </DialogTrigger>
            <DialogContent>
