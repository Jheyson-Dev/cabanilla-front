...
export const CategoryProductManagment: FC<RolManagmentProps> = ({ data }) => {
  const columns = [
        ...
        <div className="flex items-center gap-4">
          <TooltipProvider>
            <Tooltip>
              ...
              >
                <Link to={`/category-product/edit/${row.row.original.id}`}>
                  <ViewIcon size={20} />
                </Link>
              </TooltipTrigger>
              <TooltipContent>
          ...
          <CategoryProductDelete id={row.row.original.id} />
