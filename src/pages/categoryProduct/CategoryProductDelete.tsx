...
import { DELETE_CATEGORY_MUTATION } from "@/graphql/mutations/category";
...
export const CategoryProductDelete: FC<Props> = ({ id }) => {
  ...
  const eliminar = useMutation({
    mutationFn: async (id: number) => {
      try {
        return await graphqlClient.request(DELETE_CATEGORY_MUTATION, {
          id,
        });
      } catch (error) {
        return error;
