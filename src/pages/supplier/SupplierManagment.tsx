...
// Column helper for Supplier type
...
export const SupplierManagment: FC<Props> = ({ data }) => {
        ...
        <div className="flex items-center gap-4">
          <TooltipProvider>
            <Tooltip>
              ...
              >
                <Link to={`/supplier/edit/${row.row.original.id}`}>
                  <ViewIcon size={20} />
                </Link>
              </TooltipTrigger>
              <TooltipContent>
          ...
          <SupplierDelete id={row.row.original.id} />
